...
# -*- coding: utf-8 -*-
"""
CSV to PlantUML/C4 Diagram Generator - FIXED VERSION
    ...
    def generate_plantuml(self, output_file):
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            ...
            for system_name, system in self.systems.items():
                ...
                # Write system rectangle with proper line breaks
                system_header = (
                ...
                for lpar_name in system['lpars']:
                    ...
                    # Write LPAR rectangle with proper line breaks
                    lpar_header = (
                        f"  rectangle \"{lpar_name}\\n"
